...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'polygon_grouper_dialog_base.ui'))


class vgleDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(vgleDialog, self).__init__(parent)
        ...
        self.pushButton_2.clicked.connect(self.runAsBatch)
    def runAsBatch(self):
        self.close()
        dlg2 = BatchAlgorithmDialog(self.algorithm().create(), parent=iface.mainWindow())
        dlg2.show()
        dlg2.exec_()
